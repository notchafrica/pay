...
class CurrencyHydrate extends Command
{
    ...
    public function handle()
    {
        ...
        $r = Http::withOptions(['verify' => false])->get('https://api.exchangerate.host/live?source=XAF&access_key='.config('currency.api_key').'&currencies='.implode(',', Currency\Models\Currency::all()->pluck('code')->toArray()));
